...
function calcSeatingNumber(){
    ...
    for(let i = 0; i < seatingIndex.length; i++)
    {
        ...
        if(seatingIndex[i] < 16)
        {
            seat1 = 'A' + (1 + seatingIndex[i] % 16);
            console.log(seat1);
            array.push(seat1);
            console.log(array);
        ...
        else if(seatingIndex[i] < 32)
        {
            seat1 = 'B' + (1 + seatingIndex[i] % 16);
            console.log(seat1);
            array.push(seat1);
            console.log(array);
            localStorage.setItem("seating", JSON.stringify(array));
        ...
        else if(seatingIndex[i] < 48)
        {
            seat1 = 'C' + (1 + seatingIndex[i] % 16);
            console.log(seat1);
            array.push(seat1);
            console.log(array);
            localStorage.setItem("seating", JSON.stringify(array));
        ...
        else if(seatingIndex[i] < 62)
        {
            seat1 = 'D' + (1 + seatingIndex[i] % 16);
            console.log(seat1);
            array.push(seat1);
            console.log(array);
            localStorage.setItem("seating", JSON.stringify(array));
        ...
        else if(seatingIndex[i] < 96)
        {
            seat1 = 'F' + (1 + seatingIndex[i] % 16);
            console.log(seat1);
            array.push(seat1);
            console.log(array);
            localStorage.setItem("seating", JSON.stringify(array));
        ...
        else if(seatingIndex[i] < 112)
        {
            seat1 = 'G' + (1 + seatingIndex[i] % 16);
            console.log(seat1);
            array.push(seat1);
            console.log(array);
            localStorage.setItem("seating", JSON.stringify(array));
        ...
        else if(seatingIndex[i] < 128)
        {
            seat1 = 'H' + (1 + seatingIndex[i] % 16);
            console.log(seat1);
            array.push(seat1);
            console.log(array);
            localStorage.setItem("seating", JSON.stringify(array));
        ...
        else if(seatingIndex[i] < 144)
        {
            seat1 = 'I' + (1 + seatingIndex[i] % 16);
            console.log(seat1);
            array.push(seat1);
            console.log(array);
            localStorage.setItem("seating", JSON.stringify(array));
        ...
        else if(seatingIndex[i] < 160)
        {
            seat1 = 'J' + (1 + seatingIndex[i] % 16);
            console.log(seat1);
            array.push(seat1);
            console.log(array);
            localStorage.setItem("seating", JSON.stringify(array));
        ...
        else if(seatingIndex[i] < 176)
        {
            seat1 = 'K' + (1 + seatingIndex[i] % 16);
            console.log(seat1);
            array.push(seat1);
            console.log(array);
            localStorage.setItem("seating", JSON.stringify(array));
        ...
        else if(seatingIndex[i] < 192)
        {
            seat1 = 'L' + (1 + seatingIndex[i] % 16);
            console.log(seat1);
            array.push(seat1);
            console.log(array);
            localStorage.setItem("seating", JSON.stringify(array));
